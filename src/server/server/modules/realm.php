...
class Realm{
    ...
    public function __construct($action, $sid){
	    ...
	    $this->pc_db = new Crow();
	    $this->pc_db->connect("172.16.130.7", "root", "", "bigamer2");
	...
	$sql = "SELECT * FROM bg_games $where LIMIT $start, $limit";
        $Data = array();
        $MetaData = array();
	$isGetMetaData = false;
        ...
        $count = $this->pc_db->get_one("SELECT COUNT(*) as count FROM bg_games  $where");
	...
	$sql = "SELECT * FROM bg_gameoperators $where LIMIT $start, $limit";
        $Data = array();
        $MetaData = array();
	$isGetMetaData = false;
        ...
        $count = $this->pc_db->get_one("SELECT COUNT(*) as count FROM bg_gameoperators $where");
        send_ajax_response("success", array("TotalCount"=>$count["count"], "Data"=>$Data, "MetaData"=>$MetaData));
    }
